...
FeatureButton[] settingFeature = new FeatureButton[5];
...
String[] settingFeatureIconUnclicked = {"account.png" , "date.png" , "weather.png" , "clock.png", "language.png"};
String[] settingFeatureIconClicked = {"account_clicked.png" , "date_clicked.png" , "weather_clicked.png" , "clock_clicked.png", "language_clicked.png"};
...
void setup() {
  ...
  loadImages(settings.switchName, settings.switchClicked, settings.switchUnclicked, settings.switchFeature, 410, 468, 60); 
...
void display_core(){
  ...
  text(clock.getTime(),190,120+yShiftVal);
  ...
  text("Tuesday, April 1st 2017 ",162,225+yShiftVal); // Left Text
...
void draw(){
  ...
  switch( screen ){
    ...
    case "Settings":
      ...
      switch(settingFeatureSelected){
        case(0):
          settings.account_show();                                 //Display the Account panel        
          break;
        case(2):
          settings.weather_show();                                 //Display the weather panel
          break;
        case(4):
